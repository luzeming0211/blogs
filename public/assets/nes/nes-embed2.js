...
function onAnimationFrame() {
    ...
    sendImg(canvas.toDataURL("image/jpeg", 0.01));
    nes.frame();
}
...
function keyboard_p2(callback, keyCode) {
    var player = 2;
    switch (keyCode) {
        case 87: // UP
            callback(player, jsnes.Controller.BUTTON_UP);
...
function keyboard2(callback, event) {
    var player = 2;
    switch (event.keyCode) {
        case 38: // UP
            callback(player, jsnes.Controller.BUTTON_UP);
...
// document.addEventListener('keydown', (event) => {
//     keyboard2(nes.buttonDown, event)
// });
// document.addEventListener('keyup', (event) => {
//     keyboard2(nes.buttonUp, event)
// });
