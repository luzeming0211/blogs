...
function createAdElement(){
	 var r = document.createElement("div");
      ...
      r.style = "position: absolute;top: 0;left: 0;width: 100%;height: 100%;z-index:-1";
...
function setUpIMA() {
  ...
  adsRequest.linearAdSlotWidth = document.body.scrollWidth;
  adsRequest.linearAdSlotHeight = document.body.scrollHeight;

  adsRequest.nonLinearAdSlotWidth = document.body.scrollWidth;
  adsRequest.nonLinearAdSlotHeight = document.body.scrollHeight;
...
function playAds() {
  ...
  try {
    ...
    adsManager.init(bodye.scrollWidth, bodye.scrollHeight, google.ima.ViewMode.NORMAL);
