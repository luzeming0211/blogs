    ...
    <style type="text/css">
        * {
        ...
        #psp .interaction-area {
            ...
            box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.15), inset 0 0 0 3px rgba(0, 0, 0, 0.35);
            z-index: 99;
            /* END: Button */
        }
        ...
        #psp .interaction-area > button {
            ...
            box-shadow: inset 0 0 0 3px rgba(0, 0, 0, 0.55), inset 0 4px 0px 1px rgba(255, 255, 255, 0.05);
        }
        ...
        .joystickpad .pspbutton {
            ...
            box-shadow: inset 0 0 0 1px rgba(0, 0, 0, 0.55), inset 0 2px 0px 1px rgba(255, 255, 255, 0.05);
            border-radius: 10px;
            border: 0;
            color: white;
            font-size: 1.6rem;
        ...
        #psp .interaction-area .arrow.active {
            background: rgba(99, 99, 99, 0.25);
            box-shadow: inset 0 0 0 1px rgba(0, 0, 0, 0.55), inset 0 1px 0px 1px rgba(255, 255, 255, 0.05);
        }
