...
<head>
    ...
    <title>冒险岛4</title>
    <link rel="stylesheet" href="{{asset('assets/nes_new/m')}}/css/font-awesome.min.css" type="text/css">
    <link
            href="{{asset('assets/nes_new/m')}}/css/bootstrap.min.css"
            rel="stylesheet">
    <link rel="stylesheet" href="{{asset('assets/nes_new/m')}}/css/play-mobile-9d5feb7998bea67e6fe1489c45a3df36.css">
...
<div id="tips"></div>
<script src="{{asset('assets/nes_new/m/')}}/js/jquery.min.js"></script>
<script type="text/javascript" src="{{asset('assets/nes_new/m')}}/js/play-mobile-b4042d918f463eaaf846b77239552aca.js"></script>
<script type="text/javascript" src="{{asset('assets/nes_new/m')}}/js/play-mobile-9e6418b070162fc74f79a769f8a40c18.js"></script>
<script type="text/javascript" src="{{asset('assets/nes_new/m')}}/js/play-10e0778a0b61417ba80b58197e44c5ff.js"></script>
<script>
